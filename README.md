...
8. __functional\_enrichment\_new\_paths.py__
   * __Aim__: Generate the functional enrichment analysis for the nodes constituting the _new paths_ created by the newly identified experimental interactors of HHIP.  The script also generates __Supplementary Table S3__ and __Figures S6 and S7__.
